...
export default promiseMiddleware({
  promiseTypeSeparator:"",//do not use separators, we append manually for status success and fail
...
/**
 * Fixme: Copiado da lib para correção de config.promiseTypeSuffixes. Issue: https://github.com/pburtchaell/redux-promise-middleware/issues/177
...
function promiseMiddleware() {
  ...
  var promiseTypeSeparator = (config.promiseTypeSeparator===null || typeof config.promiseTypeSeparator==='undefined' ? '_' : config.promiseTypeSeparator);
